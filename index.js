...
reposPerPageSelect.value = 10;

mytxt.value = "sayakpaul";
...
function displayUserDetails(userData) {
    ...
    <div class="innerDetails">
        ...
        <p  class="txt">Location: ${userData.location || "Not specified"}</p>
        <p  class="txt">Twitter:${userData.twitter_username ? `<a href="https://c.com/${userData.twitter_username}" target="_blank">https://twitter.com/${userData.twitter_username}</a>` : "Not specified"}</p>
        </div>
    </div>
    `;
}
